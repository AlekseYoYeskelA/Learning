...
public class CountSortObjects {
    ...
    public static Worker[] countSortObject(List<Worker> workers) {
        ...
        for (int i = 0; i < workers.size(); i++) {
            countArray[workers.get(i).qualification] = countArray[workers.get(i).qualification] + 1;
        }
        ...
        for (int i = workers.size() - 1; i >= 0; i--) {
            ...
            out[countArray[worker.qualification] - 1] = worker;
            countArray[worker.qualification]--;
        }
        return out;
    }
