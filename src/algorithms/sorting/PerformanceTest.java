...
public class PerformanceTest {
    public static void main(String[] args) {
        ...
        Utils.measureTime(() -> BubbleSort.bubbleSort1(array1), "Bubble sort");
        Utils.measureTime(() -> BubbleSort.bubbleSortKnuth(array2), "Bubble sort Knuth");

        Utils.assertTrue(Arrays.equals(array1, array2));

        System.out.println();

        Utils.measureTime(() -> BubbleSort.bubbleSort1(array4), "Bubble sort");
        Utils.measureTime(() -> BubbleSort.bubbleSortKnuth(array3), "Bubble sort Knuth");

        System.out.println();

        Utils.measureTime(() -> BubbleSort.bubbleSort1(array5), "Bubble sort");
        Utils.measureTime(() -> BubbleSort.bubbleSortKnuth(array6), "Bubble sort Knuth");
        Utils.measureTime(() -> SelectionSort.selectionSort(array7), "Selection sort");
        Utils.measureTime(() -> CombSort.combSort(array8), "Comb sort");
