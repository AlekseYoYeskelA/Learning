...
public class Main {
    public static void main(String[] args) throws IOException {
        ...
        BufferedImage picture = ImageIO.read(new File("C:\\Users\\Алексей\\Desktop\\cat.jpg"));

        picture = Utils.toBufferedImage(picture.getScaledInstance(2560, 1900, Image.SCALE_SMOOTH));
