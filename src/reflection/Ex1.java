...
//        Class employeeClass3 = employee.getClass();
    ...
    Field[] allFields = employeeClass.getDeclaredFields();
        ...
        System.out.println("Return type of method " + someMethod1.getReturnType() +
        ...
        System.out.println("Return type of method " + someMethod2.getReturnType() +
        ...
        for(Method method : methods){
            System.out.println("Name of method = " + method.getName() +
                    ", return type = " + method.getReturnType() + ", parameter types = " + Arrays.toString(method.getParameterTypes()));
        }
        System.out.println("--------------------------------------");
